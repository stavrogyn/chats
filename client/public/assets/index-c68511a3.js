 ...
 */ var hc = Tt,
    ...
    kc =
        hc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function bl(e, n) {
    ...
    n.hasOwnProperty('value')
        ? eu(e, n.type, t)
        : n.hasOwnProperty('defaultValue') && eu(e, n.type, cn(n.defaultValue)),
        n.checked == null &&
...
function Ic(e, n, t, r, l, u, o, i, s) {
    ;(Et = !1), (Rr = null), Mc.apply(Dc, arguments)
}
...
function Zc(e, n, t, r, l) {
    switch (n) {
        ...
        case 'gotpointercapture':
            return (
                (u = l.pointerId),
                It.set(u, ft(It.get(u) || null, e, n, t, r, l)),
                !0
            )
    }
    return !1
...
function bu(e, n, t, r) {
    if (Ir) {
        ...
        else if ((Xo(e, r), n & 4 && -1 < Gc.indexOf(e))) {
            for (; l !== null; ) {
                var u = Jt(l)
                if (
                    (u !== null && _s(u),
...
var ut = {
    ...
    Jo = ge(tl),
    nf = A({}, tl, { dataTransfer: 0 }),
    tf = ge(nf),
    rf = A({}, Zt, { relatedTarget: 0 }),
    Nl = ge(rf),
...
var _f = He && 'TextEvent' in window && !Ct,
    Rs = He && (!ro || (Ct && 8 < Ct && 11 >= Ct)),
...
function Pf(e, n) {
    if (Dn)
        return e === 'compositionend' || (!ro && Os(e, n))
            ? ((e = Ts()), (Sr = eo = be = null), (Dn = !1), e)
            : null
    switch (e) {
        case 'paste':
            return null
...
function Fs(e) {
    if (e.propertyName === 'value' && rl(jt)) {
        var n = []
        Ds(n, jt, e, Gu(e)), vs(zf, n)
    }
}
function Tf(e, n, t) {
    e === 'focusin'
        ? (li(), (_t = n), (jt = t), _t.attachEvent('onpropertychange', Fs))
        : e === 'focusout' && li()
}
function Rf(e) {
...
for (var Rl = 0; Rl < si.length; Rl++) {
    var Ol = si[Rl],
        jf = Ol.toLowerCase(),
        Uf = Ol[0].toUpperCase() + Ol.slice(1)
    dn(jf, 'on' + Uf)
}
            ...
            P &&
                (Rs &&
                    ...
                    (Dn || P !== 'onCompositionStart'
                        ...
                        : ((be = v),
                          (eo = 'value' in be ? be.value : be.textContent),
                          (Dn = !0))),
                (_ = jr(c, P)),
                0 < _.length &&
...
var yu = typeof setTimeout == 'function' ? setTimeout : void 0,
    ...
    Hf =
        typeof queueMicrotask == 'function'
            ...
            : typeof di < 'u'
            ? function (e) {
                  return di.resolve(null).then(e).catch(Wf)
              }
            : yu
function Wf(e) {
    setTimeout(function () {
...
function I(e) {
    0 > Un || ((e.current = wu[Un]), (wu[Un] = null), Un--)
}
function M(e, n) {
    Un++, (wu[Un] = e.current), (e.current = n)
}
var fn = {},
    re = pn(fn),
    ce = pn(!1),
...
function mn() {
    if (!Fl && $e !== null) {
        ...
        try {
            ...
            throw ($e !== null && ($e = $e.slice(e + 1)), ws(Zu, mn), l)
        } finally {
            ;(O = n), (Fl = !1)
        }
    }
...
function _u(e, n, t, r) {
    var l = e.stateNode
    ;(l.props = t), (l.state = e.memoizedState), (l.refs = ea), po(e)
    var u = n.contextType
    typeof u == 'object' && u !== null
        ? (l.context = Ce(u))
...
function go(e, n, t, r, l, u) {
    if (
        ...
        (n.updateQueue = null),
        (n.lanes = 0),
        (_r.current = e === null || e.memoizedState === null ? bf : ed),
        (e = t(r, l)),
        Pt)
    ) {
        u = 0
...
function oa(e, n) {
    ...
    if (
        ...
        (r = r.queue),
        ko(aa.bind(null, t, r, e), [e]),
        r.getSnapshot !== n || u || (G !== null && G.memoizedState.tag & 1))
    ) {
        if (
            ((t.flags |= 2048),
            Kt(9, sa.bind(null, t, r, l, n), void 0, null),
            Z === null)
        )
            throw Error(y(349))
        Pn & 30 || ia(t, n, l)
...
function ha(e, n, t) {
    return (
        (t = t != null ? t.concat([e]) : null), sl(4, 4, va.bind(null, n, e), t)
    )
}
function So() {}
function ya(e, n) {
...
var Xr = {
    ...
    bf = {
        ...
        useSyncExternalStore: function (e, n, t) {
            ...
            return (
                (l.queue = u),
                _i(aa.bind(null, r, u, e), [e]),
                (r.flags |= 2048),
                Kt(9, sa.bind(null, r, u, t, n), void 0, null),
                t
            )
        },
        useId: function () {
...
function ld(e, n, t, r, l, u, o) {
    ...
    if (l.data === '$!') {
        ...
        return (
            (r = i), (u = Error(y(419))), (r = Vl(u, r, void 0)), mr(e, n, o, r)
        )
    }
...
function ad(e, n) {
    ...
    for (
        vu = { focusedElem: e, selectionRange: t }, Ir = !1, S = n;
        S !== null;
...
function de(e, n) {
    ...
    if (r === 0)
        ...
        if ((t != null && Yo(t), n === 1))
            e.tag === 0 ? Yf($i.bind(null, e)) : Xs($i.bind(null, e)),
                Hf(function () {
                    !(R & 6) && mn()
                }),
                (t = null)
            ...
            switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
                ...
                case 3:
                    if (
                        ...
                        e.timeoutHandle = yu(gn.bind(null, e, se, Ue), n)
                        break
                    }
                    gn(e, se, Ue)
                    break
                case 4:
                    ...
                    if (
                        ...
                        e.timeoutHandle = yu(gn.bind(null, e, se, Ue), r)
                        break
                    }
                    gn(e, se, Ue)
                    break
...
ps = Po
ms = zn
var xd = { usingClientEntryPoint: !1, Events: [Jt, jn, ul, fs, ds, Po] },
    ht = {
...
function zd() {
    ...
    return Wn.jsxs('div', {
        children: [
            Wn.jsxs('h1', { children: ['Count: ', t] }),
            Wn.jsx('button', { onClick: r, children: 'Increment' }),
        ],
    })
}
Nd.render(Wn.jsx(zd, {}), document.getElementById('root'))
